...
***Now that we know what years released the most movies we wanted to plot both domestic and international sales per year. We were expecting the data to show us the same trends.***
...
It was interesting to find that 2009 was the highest grossing year in sales domestically followed 2013, even though we had the most movie releases in 2012.
...
Noting the difference in movie release years versus the highest grossing years prompted us to look into sales per budgets.
...
In order identify trends, we felt it would be prudent to look more closely into the domestic sales and budget.
...
We found that a budget range could be identified as a goal for the industry to shoot for. There were some outliers but the data indicated that there was no need to be over budget in order to gross more sales.
...
Next, we wanted to compare domestic sales to internatnal sales.
...
Movies depend on there distribution. So, we wanted to identify out largest distributor.
...
We wanted to know which year each distributor had reported the highest sales. To narrow our search we limited it dataset to only list the top 10 sales.
...
As we continued to try to identify what can make a movie more profitable we decided to take a look at the top directors per distributor. We wanted to know how many movies each director was producing and who they were using as their distributor.
...
```
It was not a surprise to find Anthony Russo, who used Walt Disney studios as his distributor, direct the most films. James Cameron came in second using both Twenty Century Fox and Paramont Pictures to distribute his films.
...
In our analysis we found that the number of movies you release in year will not directly indicate a high grossing year in movie sales both internationally or domestically. We also concluded that staying within the budget is the most financially beneficial practice since being over budget did not correlate to higher grossing sales. The number of films a director produces is just as important as who they are using to distribute the film. Walt Disney studios has the farthest reach and therefore we can conclude is a great option for distribution. 

It is important to take into consideration that the data did not measure or take into account numerous factors beyond anyone's control, like weather, social or economical factors that have impacted movies sales.
